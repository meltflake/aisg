...
export const MP_PROFILES = [
  {
    ...
    zhName: "李显龙",
    role: "执政党",
    focusAreas: ["AI教育", "AI公共服务", "AI治理"],
    stance: "支持多元融合，注重教育公平与AI应用",
    debateCount: 7,
    notablePosition: "推动分龄AI教育指导与脑科学融合",
  },
  {
    name: "Tan See Leng",
    zhName: "陈志令",
    role: "执政党",
    focusAreas: ["AI就业", "劳动力转型", "AI经济"],
    stance: "强调包容性劳动力转型与技能再培训",
    debateCount: 6,
    notablePosition: "支持中年员工再培训及就业转型图",
  },
  {
    name: "Low Wu Yang Andre",
    zhName: "刘武扬",
    role: "执政党",
    focusAreas: ["AI企业监管", "AI经济", "人才培养"],
    stance: "尊重商业协议，促进本地人才发展",
    debateCount: 4,
    notablePosition: "强调技能转移与防止空壳公司利用",
  },
  {
    name: "Janil Puthucheary",
    zhName: "贾尼尔·普图查里",
    role: "执政党",
    focusAreas: ["AI教育", "技能培训", "就业"],
    stance: "鼓励终身学习，优化培训支持",
    debateCount: 3,
    notablePosition: "推动个性化AI培训及资金支持",
  },
  {
    name: "Patrick Tay Teck Guan",
    zhName: "郑德源",
    role: "执政党",
    focusAreas: ["AI就业", "AI经济", "网络安全"],
    stance: "关注AI裁员透明度及网络安全",
    debateCount: 3,
    notablePosition: "要求公开AI裁员及再就业数据",
  },
  {
    name: "Gerald Giam Yean Song",
    zhName: "江源松",
    role: "反对党",
    focusAreas: ["AI经济", "数据主权", "国际合作"],
    stance: "担忧外企主导与技术依赖",
    debateCount: 2,
    notablePosition: "强调防止全球科技巨头垄断",
  },
  {
    name: "Assoc Prof Jamus Jerome Lim",
    zhName: "林志明",
    role: "反对党",
    focusAreas: ["AI教育", "教师福利", "公共资源"],
    stance: "关注教师负担与教育资源公平",
    debateCount: 2,
    notablePosition: "建议优化教师工作分配减负",
  },
  {
    name: "Chee Hong Tat",
    zhName: "徐芳达",
    role: "执政党",
    focusAreas: ["AI伦理", "广告规范", "消费者保护"],
    stance: "推动AI广告透明及行业规范",
    debateCount: 2,
    notablePosition: "支持AI编辑图像声明指引更新",
  },
];
